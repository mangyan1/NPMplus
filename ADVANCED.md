...
- uses a bridge network, loopback-only admin port, and non-root service UID/GID by default on fresh v1.18 installations; host networking remains an explicit compatibility choice for targets on host `127.0.0.1`
