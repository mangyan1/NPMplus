...
- Fixed Azerbaijani locale flags, readable dashboard button states, mobile ban rows and toolbar behavior, and IP/CIDR/duration validation with field-specific feedback. See the [security and dashboard review](docs/security-dashboard-review-2026-09-12.md).
