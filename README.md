...
- The default **Attackers** view groups locally observed source IPs with search, sorting, older-history loading, and a chronological investigation drawer. Event evidence loads on demand; partial coverage and unavailable decision status remain explicit. See [investigating observed attackers](docs/attacker-investigation.md).
